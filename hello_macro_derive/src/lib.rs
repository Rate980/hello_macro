...
use quote::quote;
use syn::{
    self, spanned::Spanned, AngleBracketedGenericArguments, GenericArgument, Item, Path,
    PathArguments, QSelf, Type, TypeArray, TypeGroup, TypePath, TypePtr, TypeSlice, TypeTuple,
};
macro_rules! syn_err {
    ($l:literal $(, $a:expr)*) => {
